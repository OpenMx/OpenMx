...
The package manual can be accessed online in the [link](https://vipbg.vcu.edu/vipbg/OpenMx2/docs//OpenMx/latest/), and as a pdf from the [link](https://openmx.ssri.psu.edu/docs/OpenMx/latest/OpenMxUserGuide.pdf). The manual includes example models and scripts for the most common cases.

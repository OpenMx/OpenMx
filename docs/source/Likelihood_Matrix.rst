...
* http://openmx.psyc.virginia.edu/svn/tags/stable-1.2/demo/OneLocusLikelihood.R

and 

* http://openmx.psyc.virginia.edu/svn/tags/stable-1.2/demo/TwoLocusLikelihood.R

For (former) users of the first version of Mx, scripts for that software can be found here:
    
    * http://openmx.psyc.virginia.edu/svn/tags/stable-1.2/models/passing/mx-scripts/one.mx
    * http://openmx.psyc.virginia.edu/svn/tags/stable-1.2/models/passing/mx-scripts/two.mx

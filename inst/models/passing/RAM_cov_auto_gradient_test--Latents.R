...
omxCheckCloseEnough(coef(f1)-coef(f2),rep(0,10),1e-8)
omxCheckCloseEnough(f1$output$gradient-f2$output$gradient,rep(0,10),5e-4)
omxCheckCloseEnough(f1$output$fit-f2$output$fit,0,1e-11)

...
suppressWarnings(omxCheckCloseEnough(modelOut[['test30h']]$result, as.matrix(A$values[0,]), 0.001))
suppressWarnings(omxCheckCloseEnough(modelOut[['test30i']]$result, as.matrix(A$values[,0]), 0.001))

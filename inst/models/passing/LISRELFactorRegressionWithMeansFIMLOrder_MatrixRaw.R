...
# Thu Jul 19 14:21:05 Central Daylight Time 2012 -- Michael Hunter corrected typo.  Note: from March 24 until Jul 19, I thought I had a broken FIML re-ordering of data.  In fact, I had a broken test of the re-ordering and FIML re-ordering worked all along.
# 
...
rawlisdat <- latentMultipleRegExample1
...
ManExo <- names(rawlisdat)[IndManExo]
ManEnd <- names(rawlisdat)[IndManEnd]
...
names(expectedParam) <- c("l12", "l13", "l14", "l26", "l27", "l28", "l310",
 "l311", "l312", "b13", "b23", "varF1", "covF1F2", "varF2",
 "varF3", "d1", "d2", "d3", "d4", "d5", "d6",
 "d7", "d8", "e9", "e10", "e11", "e12", "m1",

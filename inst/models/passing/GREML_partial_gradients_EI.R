...
for(pds in 1:3){
	...
	omxCheckCloseEnough(test0$output$standardErrors[,1], c(1.2440571,0.8933682,0.9003011), 1e-4)
	...
	test1sa$fitfunction@.parallelDerivScheme <- pds
	...
	test1num$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test1num$output$standardErrors,0.08)
	...
	test2sa$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test2sa$output$standardErrors,5e-8)
	omxCheckCloseEnough(test0$output$gradient,test2sa$output$gradient,5e-6)
	omxCheckCloseEnough(test0$expectation$b,test2sa$expectation$b,5e-9)
	...
	test2num$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test2num$output$standardErrors,0.08)
	...
	test3sa$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$gradient,test3sa$output$gradient,5e-6)
	...
	test3num$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test3num$output$standardErrors,0.08)
	...
	test4sa$fitfunction@.parallelDerivScheme <- pds
	...
	test4num$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test4num$output$standardErrors,0.08)
	...
	test5sa$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test5sa$output$standardErrors,5e-8)
	omxCheckCloseEnough(test0$output$gradient,test5sa$output$gradient,5e-6)
	omxCheckCloseEnough(test0$expectation$b,test5sa$expectation$b,5e-9)
	...
	test5num$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test5num$output$standardErrors,0.08)
	...
	test6sa$fitfunction@.parallelDerivScheme <- pds
	...
	test6num$fitfunction@.parallelDerivScheme <- pds
	...
	omxCheckCloseEnough(test0$output$standardErrors,test6num$output$standardErrors,0.08)

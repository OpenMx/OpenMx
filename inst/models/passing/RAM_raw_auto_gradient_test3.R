...
summary(fmf2)
omxCheckCloseEnough(coef(fmf1),coef(fmf2),1e-9)
omxCheckCloseEnough(fmf1$output$standardErrors,fmf2$output$standardErrors,5e-6)
omxCheckCloseEnough(fmf1$output$fit,fmf2$output$fit,1e-11)
...
summary(fmf4)
omxCheckCloseEnough(coef(fmf3),coef(fmf4),1e-9)
omxCheckCloseEnough(fmf3$output$standardErrors,fmf4$output$standardErrors,5e-6)
omxCheckCloseEnough(fmf3$output$fit,fmf4$output$fit,5e-11)

...
omxCheckCloseEnough(multipleRegPathRaw@output$estimate[["varx"]], 1.116, 0.001) multipleRegPathRaw omxCheckCloseEnough(multipleRegPathRaw@output$estimate[["varz"]], 0.836, 0.001)

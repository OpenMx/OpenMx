...
# http://openmx.psyc.virginia.edu/thread/201#comment-692
...
mzfData <- as.matrix(subset(twin_NA_dot, zyg==1, selVars))
dzfData <- as.matrix(subset(twin_NA_dot, zyg==3, selVars))

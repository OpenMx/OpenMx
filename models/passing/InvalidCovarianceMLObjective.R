...
omxCheckError(mxRun(model), "The job for model 'model' exited abnormally with the error message: 1:Expected covariance matrix is non-positive-definite\n2:Fit function returned nan")

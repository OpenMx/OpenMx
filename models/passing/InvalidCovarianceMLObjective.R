...
omxCheckError(mxRun(model), "The job for model 'model' exited abnormally with the error message: MxComputeGradientDescent: fitfunction model.fitfunction evaluated to nan (Expected covariance matrix is non-positive-definite)")

...
omxCheckError(mxRun(model), "The job for model 'model' exited abnormally with the error message: Expected covariance matrix is non-positive-definite after 3 evaluations")

...
be <- mxMatrix("Zero", numLatEnd, numLatEnd, name='BE') #DONE
...
th <- mxMatrix("Zero", numManExo, numManEnd, name='TH') #DONE
...
ka <- mxMatrix("Zero", numLatExo, 1, name='KA') #DONE

al <- mxMatrix("Zero", numLatEnd, 1, name='AL') #DONE

...
expectVal <- c(0.809023, 1.148336, 1.305359, 0.80529, 1.232041, 
...
expectSE <- c(0.073166, 0.088502, 0.096505, 0.0788, 0.113654, 0.104821, 0.056678, 
...
expectVal <- c(0.809021, 1.148334, 1.305356, 0.990778, 0.805289, 
...
expectSE <- c(0.073152, 0.088483, 0.096479, 0.088473, 0.078783, 0.113624, 
...
omxCheckCloseEnough(expectVal, threeLatentMultipleReg1Out@output$estimate, 0.001)
...
expectVal <- c(0.823312, 1.178891, 1.348899, 0.791461, 1.220494, 
...
expectSE <- c(0.077248, 0.094604, 0.104575, 0.078149, 0.113009, 0.104635, 
...
expectVal <- c(0.814491, 1.150163, 1.298783, 1.045046, 0.791358, 
...
expectSE <- c(0.073471, 0.089084, 0.097044, 0.094182, 0.078301, 0.113157, 
...
omxCheckCloseEnough(expectVal, threeLatentMultipleReg3Out@output$estimate, 0.001)
...
expectVal <- c(0.822342, 1.178877, 1.353015, 0.794595, 1.218425, 
...
expectSE <- c(0.077294, 0.094581, 0.104766, 0.078581, 0.113482, 0.106016, 

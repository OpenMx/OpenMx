...
omxCheckCloseEnough(model[['test41']]@result,  matrix(Re(eigen(A@values)$values)), 0.001)
omxCheckCloseEnough(model[['test41a']]@result, matrix(Re(eigen(G@values)$values)), 0.001)
omxCheckCloseEnough(model[['test41b']]@result, matrix(Re(eigen(H@values)$values)), 0.001)
...
omxCheckCloseEnough(model[['test43']]@result,  matrix(Im(eigen(A@values)$values)), 0.001)
omxCheckCloseEnough(model[['test43a']]@result, matrix(Im(eigen(G@values)$values)), 0.001)
omxCheckCloseEnough(model[['test43b']]@result, matrix(Im(eigen(H@values)$values)), 0.001)

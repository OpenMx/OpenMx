...
model <- mxModel(A, B, C, D, E, G, H, V, M, L, U, name = 'model')
zeta <- 'z'
alpha <- 'a'
two <- 2
...
omxCheckCloseEnough(model[['test40']]@result,  matrix(Re(eigen(A@values)$vectors), 5, 5), 0.001)
omxCheckCloseEnough(model[['test40a']]@result, matrix(Re(eigen(G@values)$vectors), 2, 2), 0.001)
omxCheckCloseEnough(model[['test40b']]@result, matrix(Re(eigen(H@values)$vectors), 4, 4), 0.001)
omxCheckCloseEnough(model[['test41']]@result,  matrix(Re(eigen(A@values)$values), 5, 1), 0.001)
omxCheckCloseEnough(model[['test41a']]@result, matrix(Re(eigen(G@values)$values), 2, 1), 0.001)
omxCheckCloseEnough(model[['test41b']]@result, matrix(Re(eigen(H@values)$values), 4, 1), 0.001)
omxCheckCloseEnough(model[['test42']]@result,  matrix(Im(eigen(A@values)$vectors), 5, 5), 0.001)
omxCheckCloseEnough(model[['test42a']]@result, matrix(Im(eigen(G@values)$vectors), 2, 2), 0.001)
omxCheckCloseEnough(model[['test42b']]@result, matrix(Im(eigen(H@values)$vectors), 4, 4), 0.001)
omxCheckCloseEnough(model[['test43']]@result,  matrix(Im(eigen(A@values)$values), 5, 1), 0.001)
omxCheckCloseEnough(model[['test43a']]@result, matrix(Im(eigen(G@values)$values), 2, 1), 0.001)
omxCheckCloseEnough(model[['test43b']]@result, matrix(Im(eigen(H@values)$values), 4, 1), 0.001)

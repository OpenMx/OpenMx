...
expectVal <- c(0.703921, 0.642147, 0.95265, 0.985615, 1.218976, 
...
expectSE <- c(0.092156, 0.090827, 0.097117, 0.099476, 0.102465, 0.089168, 
...
expectVal <- c(0.71589, 0.652159, 0.955592, 0.96467, 1.240036, 0.968256, 
...
expectSE <- c(0.091768, 0.090312, 0.095406, 0.097918, 0.098236, 0.08515, 
...
expectVal <- c(0.716165, 0.652282, 0.955552, 0.964369, 1.24112, 
...
expectSE <- c(0.09167, 0.090289, 0.095411, 0.097799, 0.098073, 0.085161, 
...
omxCheckCloseEnough(expectSE, 
    as.vector(threeFactorObliqueRaw2Out@output$standardError), 0.001)
...
expectVal <- c(0.323129, 0.29047, 0.34297, 0.282883, 1.243405, 0.96688, 
...
expectSE <- c(0.087632, 0.085805, 0.094044, 0.097024, 0.098053, 0.08524, 

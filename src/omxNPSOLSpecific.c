...
/* Objective Function */
void F77_SUB(npsolObjectiveFunction)	( int* mode, int* n, double* x, double* f, double* g, int* nstate );				// For general computation
void F77_SUB(npsolLimitObjectiveFunction)(	int* mode, int* n, double* x, double* f, double* g, int* nstate );			// For limit computations

/* Constraint Function */
void F77_SUB(npsolConstraintFunction)(int *mode, int *ncnln, int *n, int *ldJ, int *needc, double *x, double *c, double *cJac, int *nstate);	// Constraints in the style of old Mx

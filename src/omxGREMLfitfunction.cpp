...
#pragma omp parallel num_threads(nThreadz)
{
	...
	for(i=istart; i < iend; i++){
		...
		/*The buildParamMap member function of omxGREMLFitState ensures that the elements of dV and dVnames are
		in order, by their corresponding parameter number, which is the order they appear in the freeVarGroup.  So,
		duh, obviously, the free parameter number for row hrn of the Hessian is hrn:*/

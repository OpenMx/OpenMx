...
setGeneric("genericGetParameters",
	function(expectation, model) {
		return(standardGeneric("genericGetParameters"))
	})
...
setMethod("genericGetParameters", "MxBaseExpectation",
	  function(expectation, model) stop("Not implemented"))
